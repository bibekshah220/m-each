...
const Logo = ({ size = "md", variant = "default", showText = true }: LogoProps) => {
    ...
    return (
        <div className="flex items-center gap-2">
            ...
            >
                {/* Signal waves left */}
                <path d="M28 22 Q18 30 18 40 Q18 50 28 58" fill="none" stroke={strokeColor} strokeWidth="3" strokeLinecap="round" />
                <path d="M22 15 Q8 26 8 40 Q8 54 22 65" fill="none" stroke={strokeColor} strokeWidth="3" strokeLinecap="round" />

                {/* Signal waves right */}
                <path d="M72 22 Q82 30 82 40 Q82 50 72 58" fill="none" stroke={strokeColor} strokeWidth="3" strokeLinecap="round" />
                <path d="M78 15 Q92 26 92 40 Q92 54 78 65" fill="none" stroke={strokeColor} strokeWidth="3" strokeLinecap="round" />
